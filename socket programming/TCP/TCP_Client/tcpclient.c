...
int main(int argc, char **argv) {
    ...
    FILE *fp = fopen(filename_temp,"rb");
    // printf("\n@@@@@@@@@@@\n");
    fseek(fp, 0, SEEK_END); 
    // printf("\n**********\n");
    ...
    // printf("Please enter file nane: ");
    // bzero(buf, BUFSIZE);
    // fgets(buf, BUFSIZE, stdin);

    /* send the message line to the server */
    // printf("\n\n\n\n\n\n****\n%s\n*****\n\n\n\n",filename_temp);
    n = write(sockfd, filename_temp, strlen(filename_temp));
    if (n < 0) 
    ...
    while(!feof(fp))
    {
        ...
        // int temp_size = snprintf ( temp, 20, " seq_len : %d", i);
        // strcat(buf,temp);
        // printf("\n********\n");
        // printf("\n\n\n\n\n\n****\n%s\n*****\n\n\n\n",buf);
